...
class Task {
    ...
    constructor(id: String, title: String, description: String, dueDate: Date?, course: Course?, status: TaskStatus, images: MutableList<ImageData>, reminderScheduled: Boolean){
        this.id = id
        this.title = title
